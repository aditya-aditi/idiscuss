    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/Courosel1.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="img/corosel2.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="img/Courosel3.jpg" class="d-block w-100" alt="...">
            </div>
        </div>
        ...
        <div class="row">
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                <div class="card my-2" style="width: 18rem;">
                    <img src="img/card-'. $id .'.jpg" class="card-img-top" alt="Image for category - '. $cat .'">
                    <div class="card-body">
